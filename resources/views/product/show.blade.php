	...
	<div class="page-area product-page spad">
		<div class="container">
			<div class="row">
				<div class="col-lg-6">
					<figure>
						<img class="product-big-img" src="{{ asset('img/product/1.jpg') }}" alt="">
					</figure>
					<div class="product-thumbs">
						<div class="product-thumbs-track">
							<div class="pt" data-imgbigurl="{{ asset('img/product/1.jpg') }}"><img src="{{ asset('img/product/thumb-1.jpg') }}" alt=""></div>
							<div class="pt" data-imgbigurl="{{ asset('img/product/2.jpg') }}"><img src="{{ asset('img/product/thumb-2.jpg') }}" alt=""></div>
							<div class="pt" data-imgbigurl="{{ asset('img/product/3.jpg') }}"><img src="{{ asset('img/product/thumb-3.jpg') }}" alt=""></div>
							<div class="pt" data-imgbigurl="{{ asset('img/product/4.jpg') }}"><img src="{{ asset('img/product/thumb-4.jpg') }}" alt=""></div>
						</div>
					</div>
				</div>
				<div class="col-lg-6">
